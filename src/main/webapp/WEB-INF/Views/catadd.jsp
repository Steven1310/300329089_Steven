...
<div class="container">
    ...
    <form method="POST">
        <div class="form-group">
            ...
            <input type="text" name="clientno" class="form-control" id="clientno" value="${clientno}">
        </div>
        <div class="form-group">
            <label for="clientname">Client Name:</label>
            <input type="text" name="clientname" class="form-control" id="clientname" value="${clientname}">
        </div>
        <div class="form-group">
            <label for="loanamount">Loan Amount:</label>
            <input type="text" name="loanamount" class="form-control" id="loanamount" value="${loanamount}">
        </div>
        <div class="form-group">
